...
import { useConnectionConfig } from 'contexts/ConnectionContextProvider';
...
const Button: FC<ButtonProps> = (props) => {
  return (
    <button
      className={`text-xs md:text-base wallet-adapter-button ${props.className || ''
        }`}
...
export const WalletMultiButton: FC<ButtonProps> = ({ children, ...props }) => {
  ...
  return (
    <div className="wallet-adapter-dropdown mx-auto">
      <Button
